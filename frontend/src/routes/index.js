  ...
  return useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        { path: "app", element: (<GeneralApp children={< Chats />} />) },
        { path: "group", element: (<GeneralApp children={< Group />} />) },
...
// const ChatComponent = Loadable(lazy(() => import("../pages/dashboard/Conversation")));
